...
void Ship::makeSkinShip(bool visiable){
    ...
    if(getHorizontal()){
        switch (getNumDeck()) {
        case 1:
            setPixmap(QPixmap(QString(":/images/ship1.png")));
            pixItem1->setPixmap(QPixmap(QString(":/images/ship1(1).png")));
            pixItem1->setPos(5,5);
            ...
            break;
        case 2:
            setPixmap(QPixmap(QString(":/images/ship2.png")));
            pixItem1->setPixmap(QPixmap(QString(":/images/ship2(1).png")));
            pixItem1->setPos(10,4);
            pixItem1->setVisible(visiable);
            cell1->setImage(pixItem1);
            cell1->isShip = true;

            pixItem2->setPixmap(QPixmap(QString(":/images/ship2(2).png")));
            pixItem2->setPos(0,4);
            ...
            break;
        case 3:
            setPixmap(QPixmap(QString(":/images/ship3.png")));
            pixItem1->setPixmap(QPixmap(QString(":/images/ship3(1).png")));
            pixItem1->setPos(10,3);
            pixItem1->setVisible(visiable);
            cell1->setImage(pixItem1);
            cell1->isShip = true;

            pixItem2->setPixmap(QPixmap(QString(":/images/ship3(2).png")));
            pixItem2->setPos(0,3);
            pixItem2->setVisible(visiable);
            cell2->setImage(pixItem2);
            cell2->isShip = true;

            pixItem3->setPixmap(QPixmap(QString(":/images/ship3(3).png")));
            pixItem3->setPos(0,3);
            ...
            break;
        case 4:
            setPixmap(QPixmap(QString(":/images/ship4.png")));
            pixItem1->setPixmap(QPixmap(QString(":/images/ship4(1).png")));
            pixItem1->setPos(10,2);
            pixItem1->setVisible(visiable);
            cell1->setImage(pixItem1);
            cell1->isShip = true;

            pixItem2->setPixmap(QPixmap(QString(":/images/ship4(2).png")));
            pixItem2->setPos(0,2);
            pixItem2->setVisible(visiable);
            cell2->setImage(pixItem2);
            cell2->isShip = true;

            pixItem3->setPixmap(QPixmap(QString(":/images/ship4(3).png")));
            pixItem3->setPos(0,2);
            pixItem3->setVisible(visiable);
            cell3->setImage(pixItem3);
            cell3->isShip = true;
            ...
            pixItem4->setPixmap(QPixmap(QString(":/images/ship4(4).png")));
            pixItem4->setPos(0,2);
        ...
        switch (getNumDeck()) {
        case 1:
            setPixmap(QPixmap(QString(":/images/ship1v.png")));
            pixItem1->setPixmap(QPixmap(QString(":/images/ship1(1)v.png")));
            pixItem1->setPos(5,5);
            pixItem1->setVisible(visiable);
            cell1->setImage(pixItem1);
            cell1->isShip = true;
            break;
        case 2:
            setPixmap(QPixmap(QString(":/images/ship2v.png")));
            pixItem1->setPixmap(QPixmap(QString(":/images/ship2(1)v.png")));
            pixItem1->setPos(4,10);
            pixItem1->setVisible(visiable);
            cell1->setImage(pixItem1);
            cell1->isShip = true;

            pixItem2->setPixmap(QPixmap(QString(":/images/ship2(2)v.png")));
            pixItem2->setPos(4,0);
            pixItem2->setVisible(visiable);
            cell2->setImage(pixItem2);
            cell2->isShip = true;
            break;
        case 3:
            setPixmap(QPixmap(QString(":/images/ship3v.png")));
            pixItem1->setPixmap(QPixmap(QString(":/images/ship3(1)v.png")));
            pixItem1->setPos(3,10);
            pixItem1->setVisible(visiable);
            cell1->setImage(pixItem1);
            cell1->isShip = true;

            pixItem2->setPixmap(QPixmap(QString(":/images/ship3(2)v.png")));
            pixItem2->setPos(3,0);
            pixItem2->setVisible(visiable);
            cell2->setImage(pixItem2);
            cell2->isShip = true;

            pixItem3->setPixmap(QPixmap(QString(":/images/ship3(3)v.png")));
            pixItem3->setPos(3,0);
            pixItem3->setVisible(visiable);
            cell3->setImage(pixItem3);
            cell3->isShip = true;
            break;
        case 4:
            setPixmap(QPixmap(QString(":/images/ship4v.png")));
            pixItem1->setPixmap(QPixmap(QString(":/images/ship4(1)v.png")));
            pixItem1->setPos(2,10);
            pixItem1->setVisible(visiable);
            cell1->setImage(pixItem1);
            cell1->isShip = true;

            pixItem2->setPixmap(QPixmap(QString(":/images/ship4(2)v.png")));
            pixItem2->setPos(2,0);
            pixItem2->setVisible(visiable);
            cell2->setImage(pixItem2);
            cell2->isShip = true;

            pixItem3->setPixmap(QPixmap(QString(":/images/ship4(3)v.png")));
            pixItem3->setPos(2,0);
            pixItem3->setVisible(visiable);
            cell3->setImage(pixItem3);
            cell3->isShip = true;

            pixItem4->setPixmap(QPixmap(QString(":/images/ship4(4)v.png")));
            pixItem4->setPos(2,0);
            pixItem4->setVisible(visiable);
            cell4->setImage(pixItem4);
            cell4->isShip = true;
